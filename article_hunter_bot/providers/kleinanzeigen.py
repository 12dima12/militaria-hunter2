...
class KleinanzeigenProvider(BaseProvider):
    ...
    def build_search_url(self, keyword: str, page: int = 1) -> str:
        ...
        if normalized_page <= 1:
            ...
            path = f"/s-seite:{normalized_page}/{slug}/"
    ...
    def _candidate_paths(self, keyword: str, page: int) -> List[str]:
        ...
        if normalized_page <= 1:
            ...
            raw = [
                f"/s-seite:{normalized_page}/{slug}/",
                f"/s-seite:{normalized_page}/{slug}/k0",
                f"/s-seite:{normalized_page}/suchanfrage-{slug}/k0",
                f"/s/{slug}/k0/seite:{normalized_page}",
            ]
