...
class Militaria321Provider(BaseProvider):
    ...
    def __init__(self):
        ...
        self.headers = {
            ...
            "Accept-Encoding": "gzip, deflate",  # Remove br (brotli) for compatibility
            "Accept-Language": "de-DE,de;q=0.9,en-US;q=0.8,en;q=0.7",  # German as specified
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebNet/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36",
